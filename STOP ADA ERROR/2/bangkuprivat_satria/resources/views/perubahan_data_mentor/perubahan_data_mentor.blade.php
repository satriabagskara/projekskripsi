                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body mt-3">
                            <form class="form-horizontal" action="{{ url('/perubahan_data/mentor/save') }}" method="post"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12" style="margin-bottom:1%;">
                                        ...
                                        <input id="detail_skill" class="col-md-12 form-control" type="text"
                                            name="detail_skill" maxlength="500" value="{{ $data_mentor->detail_skill }}"
                                    ...
                                    <div class="col-md-12" style="margin-bottom:3%;">
                                        ...
                                        <textarea id="biodata" class="col-md-12 form-control" name="biodata" maxlength="500"
                                            ...
                                            required>{{ $data_mentor->biodata }}</textarea>
                                    </div>
                                </div><br>
                                    ...
                                    @foreach ($detail_skill as $key => $value)
                                        <div id="div_keahlian{{ $key }}" class="form-group row col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select id="keahlian{{ $key }}" onfocus="this.size=5;"
                                                    onblur="this.size=5;" onchange="this.size=5; this.blur();"
                                                    onfocusout="this.size=null;" class=" col-md-12 form-control"
                                                    name="keahlian[]" onclick="pilih_skill({{ $key }});" required>
                                                    @foreach ($skill as $val)
                                                        @if ($value->skill_id == $val->id)
                                                            <option value="{{ $val->id }}" selected>
                                                                {{ $val->skill }}</option>
                                                        @else
                                                            <option value="{{ $val->id }}">{{ $val->skill }}
                                                            </option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input id="pengalaman_bidang{{ $key }}"
                                                    class="col-md-12 form-control" type="number" name="pengalaman_bidang[]"
                                                    value="{{ $value->lama_pengalaman }}"
                                                    placeholder="Lama Pengalaman Di Bidang" required>
                                            </div>
                                            @if ($key != 0)
                                                <div class="col-md-3">
                                                    <button type="button" class="btn btn-sm btn-danger"
                                                        onclick="hapus_keahlian({{ $key }})"><i
                                ...
                                <div class="form-group row">
                                                ...
                                                <div class="col-md-3">
                                                    @if ($val->nilai != 0)
                                                        <input id="hari_mengajar{{ $val->id }}" type="checkbox"
                                                            ...
                                                            value="{{ $val->id }}"
                                                            onclick="checkbox({{ $val->id }})" checked>
                                                        {{ $val->hari }}
                                                    @else
                                                        <input id="hari_mengajar{{ $val->id }}" type="checkbox"
                                                            class="ml-3" name="hari_mengajar[]"
                                                            value="{{ $val->id }}"
                                                            onclick="checkbox({{ $val->id }})"> {{ $val->hari }}
                                                    @endif
                                                </div>
                                                <div class="col-md-8">
                                                    @if ($val->nilai != 0)
                                                        <input id="start_jam{{ $val->id }}" name="start_jam[]"
                                                            value="{{ $val->start_jam }}" type="time">
                                                        <label>s/d</label>
                                                        <input id="end_jam{{ $val->id }}" name="end_jam[]"
                                                            value="{{ $val->end_jam }}" type="time">
                                                    @else
                                                        <input id="start_jam{{ $val->id }}" name="start_jam[]"
                                                            type="time" disabled>
                                                        <label>s/d</label>
                                    ...
                                    <div class="col-md-12" style="margin-bottom:3%;">
                                        ...
                                        <textarea id="metode_pengajaran" class="col-md-12 form-control"
                                            ...
                                            required>{{ $data_mentor->detail_pengajaran }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input id="harga_jam" class="col-md-12 form-control" type="text" name="harga_jam"
                                            value="Rp. {{ number_format($data_mentor->harga_perjam, 0, ',', '.') }}"
                                    ...
                                    <div class="col-md-12" style="margin-bottom:2%;">
                                        ...
                                        <input id="pengalaman_ngajar" class="col-md-12 form-control" type="number"
                                            name="pengalaman_ngajar" value="{{ $data_mentor->pengalaman_ngajar }}"
                                            placeholder="Pengalaman Mengajar (dalam tahun)." required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input id="medsos_linkedin" class="col-md-6 form-control" type="text"
                                            name="medsos_linkedin" value="{{ $data_mentor->medsos_linkedin }}"
                                            placeholder="Https://www.linkedin.com/in" required>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="medsos_github" class="col-md-12">Github</label>
                                        <input id="medsos_github" class="col-md-6 form-control" type="text"
                                            name="medsos_github" value="{{ $data_mentor->medsos_github }}"
                                    ...
                                    <div class="col-md-12" style="margin-bottom:2%;">
                                        ...
                                        <input id="medsos_instagram" class="col-md-6 form-control" type="text"
                                            name="medsos_instagram" value="{{ $data_mentor->instagram }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12" style="margin-bottom:1%;">
                                        ...
                                        <input id="file_resume" class="col-md-6 form-control" type="file"
                                            name="file_resume">
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group mt-4 mb-5 col-md-8">
                                        ...
                                        <button type="submit" class="btn btn-primary"
                                            onclick="return confirm('Apakah Anda Yakin Dengan Data Anda?')"><i
                                                class="fa fa-save"></i> Ajukan Perubahan</button>
                                    </div>
                                </div>
                            </form>
                        </div>
