...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-8">
                    <h1 class="text-primary" style="font-size:35px;">Detail Pengajuan Mentor , {{ $detail_mentor->nama }}
                    </h1>
                </div>
                <div class="col-sm-4">
                ...
                <a href="{{ url('/pengajuan_mentor') }}" type="button" class="btn btn-warning"><i
                    ...
                    <div class="row">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="row ml-3">
                                        ...
                                        <a class="col-md-1">:</a>
                                        <a class="col-md-6 text-left">{{ $detail_mentor->pengalaman_ngajar }} Tahun
                                            Mengajar</a>
                                    </div><br>
                                    <div class="row ml-3">
                                        <a class="col-md-4 text-left"><b class="bg-success">Rp.
                                                {{ number_format($detail_mentor->harga_perjam, 0, ',', '.') }}/
                                                Jam</b></a>
                        ...
                        <div class="card col-sm-6 mb-3">
                            ...
                            <div class="row">
                                ...
                                <a class="col-md-1 text-center">:</a>
                                <a class="row col-md-7 ">{{ $detail_mentor->alamat_detail }}</a>
                            </div>
                    ...
                    <div class="row">
                        <div class="card col-md-12">
                            ...
                            <div class="row ml-3">
                                ...
                                <a class="row col-md-10 ml-5"><b>{{ $detail_mentor->detail_skill }}</b></a>
                                    ...
                                    <div class="col-md-12 ml-5">
                                        @foreach ($detail_hari as $key => $value)
                                            <div class="col-md-12">
                                                ...
                                                <input class="col-md-1.5" type="time"
                                                    value="{{ $value->start_jam }}" readonly>
                                                <label>s/d</label>
