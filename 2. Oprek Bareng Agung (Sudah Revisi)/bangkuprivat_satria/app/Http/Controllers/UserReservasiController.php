...
class UserReservasiController extends Controller
{
  ...
  public function pengajuan_reservasi($id)
  {
      ...
      $not_avaliable_time = detail_reservasi::where('detail_mentor_id', $id)->get();
      // dd($not_avaliable_time);
      return view('reservasi_user.mulai_pengajuan_user', compact('data_mentor','hari','tipe_pengajaran','kebutuhan','not_avaliable_time'));
  }
