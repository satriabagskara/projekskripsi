...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="text-primary" style="font-size:40px;">Selamat Datang , {{ $detail_mentor->nama }}</h1>
                </div>
                <div class="col-sm-6">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card" style="max-width:98%;">
                ...
                <div class="card-body">
                    <h3 class="text-center bg-info text-light">PROFIL UMUM ANDA</h3>
                    <div class="row">
                            ...
                            <div class="media">
                                @if ($detail_mentor->fhoto != null)
                                    <img src="{{ url('/Foto_Profile/' . $detail_mentor->path_fhoto, $detail_mentor->fhoto) }}"
                                        class="img-circle mt-5" style="width:15%;">
                                @else
                        ...
                        if($jumlah_data == 0){
                          ...
                          if($jml_star < 5){
                            ...
                            for( $a=$val;$a>0;$a--){ ?>
                                            ...
                                            @else
                                                <i style="color:grey;">({{ $jml_ulasan[0]->total_ulasan }} Ulasan)</i>
                                            @endif
                                        </a>
                                    </div>
                                    <div class="row ml-3">
                                        ...
                                        <a class="col-md-1">:</a>
                                        <a class="col-md-7 text-left">{{ $detail_mentor->nama }}</a>
                                    </div>
                                    <div class="row ml-3">
                                        <a class="col-md-4"><b>Jenis Kelamin</b></a>
                                        <a class="col-md-1">:</a>
                                        <a class="col-md-7 text-left">{{ $detail_mentor->gender }}</a>
                                    </div>
                                    <div class="row ml-3">
                                        <a class="col-md-4"><b>Tanggal Lahir</b></a>
                                        <a class="col-md-1">:</a>
                                        <a class="col-md-7 text-left">{{ $detail_mentor->tgl_lahir }}</a>
                                    </div><br>
                                    <div class="row ml-3">
                                        <a class="col-md-4"><b>Email</b></a>
                                        <a class="col-md-1">:</a>
                                        <a class="col-md-7 text-left">{{ $detail_mentor->email }}</a>
                                    </div>
                                    <div class="row ml-3">
                                        <a class="col-md-4"><b>No. Hp/Tlp</b></a>
                                        <a class="col-md-1">:</a>
                                        <a class="col-md-7 text-left">{{ $detail_mentor->no_hp }}</a>
                                    </div>
                                    <div class="row ml-3">
                                        <a class="col-md-4"><b>Pengalaman</b></a>
                                        <a class="col-md-1">:</a>
                                        <a class="col-md-7 text-left">{{ $detail_mentor->pengalaman_ngajar }} Tahun
                                            Mengajar</a>
                                    </div><br>
                                    <div class="row ml-3">
                                        <a class="col-md-4 text-left"><b class="bg-success">Rp.
                                                {{ number_format($detail_mentor->harga_perjam, 0, ',', '.') }}/ Jam</b></a>
                                        <a class="btn btn-sm btn-info" type="button" target="_blank"
                                            href="{{ asset('/resume_mentor/' . $detail_mentor->path_document . '/' . $detail_mentor->document) }}"><i
                                                class="fas fa-eye"></i> Cek Document</a>
                                    </div><br>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="card">
                            <h3 class="text-center bg-info text-light">DETAIL PENGAJARAN ANDA</h3>
                            <div class="row ml-3">
                ...
                <!-- start medsos -->
                <div class="card-body">
                    <h3 class="text-center bg-info text-light">Media Sosial ANDA</h3>
                    <div class="row">
