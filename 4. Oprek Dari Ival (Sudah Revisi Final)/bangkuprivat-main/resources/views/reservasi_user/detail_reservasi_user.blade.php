        ...
        <div class="row">
          <div class="card col-sm-6 mb-3">
            <div class="media">
              ...
              <img src="{{url('/Foto_Profile/'.$detail_reservasi->user->path_fhoto,$detail_reservasi->user->fhoto)}}"
              ...
              <div class="media-body">
                ...
                <div class="row ml-3">
                  ...
                  <a class="col-md-6 text-left">{{$detail_reservasi->user->tempat_lahir}},
                    {{$detail_reservasi->user->tgl_lahir}}</a>
                  @else
                  <a class="col-md-6 text-left"> - </a>
                  @endif
                </div><br>
          ...
          <div class="card col-sm-4 mb-3">
            <div class="media">
              ...
              <div class="media-body">
                ...
                <h5 class="col-md-12 text-left ml-3" style="margin-top:-4%;"><b class="bg-success">Rp.
                    {{ number_format($detail_mentor->harga_perjam,0,",",".") }}/ Jam</b></h5>
                @if($detail_reservasi->status_id == 10 || $detail_reservasi->status_id == 11 ||
                $detail_reservasi->status_id == 12)
                <p class="col-md-12 ml-3">{{$detail_mentor->no_hp}}</p>
                <p class="col-md-12 ml-3" style="margin-top:-5%;">{{$detail_mentor->email}}</p>
                @endif
              </div>
            </div>
            <a class="col-md-12 text-left">{{$detail_mentor->nama}} | {{$detail_mentor->pengalaman_ngajar}} Tahun
              Mengajar</a>
          </div>
