          ...
          <div class="card-body mt-3">
            ...
            <div class="row" style="margin-bottom:auto;">
              <div class="card col-sm-1 text-center">
                ...
                <a><img src="{{url('/Foto_Profile/'.$value->mentor->path_fhoto,$value->mentor->fhoto)}}"
                    class="img-circle mt-4" style="width:100%;max-height:50%;"></a>
                @else
                <a><img src="{{url('/TemplateHome/dist/img/user.jpg')}}" class="img-circle mt-4"
                    style="width:100%;"></a>
                @endif
              </div>
              ...
              <div class="card col-sm-4">
                <p class="text-center" style="margin-bottom:-2%;"><b>Kebutuhan</b></br>{{$value->kebutuhan->kebutuhan}}
                </p>
                <hr>
              ...
              <div class="card col-sm-3">
                ...
                <br><br>
                <p class="text-center" style="margin-bottom:-2%;"><b>Status </b></br><i class="text-info">Menunggu
                    Konfirmasi.</i></p>
                @elseif($value->status_id == 5)
                <p class="text-center" style="margin-bottom:-2%;"><b>Status </b></br><i class="text-primary">Silahkan
                    Melakukan Pembayaran.</i></p>
                <hr>
                <input type="hidden" id="idBayar" value="{{$value->id}}">
                <button onclick="bayar()" type="button" id="btn-bayar" data-toggle="modal" data-target="#Modal_Bayar"
                  class="btn btn-sm btn-info text-light"><i class="fas fa-money"></i> Bayar</button>
                @elseif($value->status_id == 6 || $value->status_id == 7)
                <p class="text-center" style="margin-bottom:-2%;"><b>Status </b></br><i class="text-danger">Reservasi
                    DiTolak.</i></p>
                <hr>
                ...
                <a type="button" data-toggle="modal" data-target="#Modal_Cek_pembayaran" class="btn btn-sm btn-warning"
                  title="Cek Bukti Pembayaran" onclick="cek_pembayaran({{$value->id}});"><i class="fa fa-search"></i>
                  Cek Pembayaran</a>
                @endif
                <hr>
                <p class="text-center" style="margin-bottom:-2%;"><b>Status </b></br><i class="text-success">Menunggu
                    Konfirmasi.</i></p>
                @elseif($value->status_id == 9)
                <p class="text-center" style="margin-bottom:-2%;"><b>Status </b></br><i class="text-danger">Pembayaran
                    DiTolak.</i></p>
                <hr>
                <p class="text-center"><b>Alasan </b></br>{{$value->alasan_ditolak}}</p>
                @elseif($value->status_id == 10)
                <br><br>
                <p class="text-center" style="margin-bottom:-2%;"><b>Status </b></br><i class="text-success">Reservasi
                    Sedang Berjalan.</i></p>
                @elseif($value->status_id == 11)
                <p class="text-center" style="margin-bottom:-2%;"><b>Status </b></br><i class="text-primary">Reservasi
                    Selesai, Silahkan Berikan Ulasan.</i></p>
                <hr>
                <a type="button" data-toggle="modal" data-target="#Modal_Ulasan" class="btn btn-sm btn-warning"
                  onclick="ulasan({{$value->id}})"><i class="fas fa-pen"></i> Berikan Ulasan</a>
                @elseif($value->status_id == 12)
                <p class="text-center" style="margin-bottom:-2%;"><b>Status </b></br><i class="text-primary">Reservasi
                    Selesai, Terima Kasih.</i></p>
                <hr>
              ...
              <div class="card col-sm-2 text-center"><br><br>
                <a href="{{url('/detail_reservasi/user/'.$value->id)}}" type="button" class="btn btn-sm btn-info"><i
                    class="fas fa-eye"></i> Cek Detail</a>
...
<div class="modal fade" id="Modal_Bayar" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <form class="form-horizontal" action="{{url('/pembayaran/reservasi')}}" method="POST"
        ...
        <div class="modal-body card mx-2">
          <div class="row">
            <div class="col-md-12">
              <a style="text-align:justify;">*<i>Setelah melakukan pembayaran harap konfirmasi ke admin melalui nomor
                  yang tersedia pada saat proses reservasi sebelumnya.</i></a>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <a style="text-align:justify;">**<i>Setelah melakukan pembayaran mentor akan menghubungi anda mengenai
                  proses pembelajaran.</i></a>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <a style="text-align:justify;">***<i>Setelah proses pembayaran terlaksana proses pembelajaran akan dimulai
                  sesuai jadwal yang ditentukan.</i></a>
            </div>
          </div><br>
          <div class="row mx-2">
            ...
            <div class="card col-sm-6 mb-3">
              ...
              <input type="text" class="form-control" name="asal_bank" placeholder="Masukkan Bank Yang Digunakan"
                required><br>
              <label><b>Atas Nama Pengirim</b></label>
              <input type="text" class="form-control" name="atas_nama_pengirim"
                placeholder="Masukkan Atas Nama Pengirim" required><br>
            </div><br>
          </div>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn btn-success"
            onclick="return confirm('Apakah Anda Yakin Dengan Data Anda?')"><i class="fa fa-save"></i> Simpan
            Pembayaran</button>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <form class="form-horizontal" action="{{url('/beri/ulasan')}}" method="POST">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="card col-sm-12 mb-3">
              <div class="media">
                <img id="ulas_fhoto" src="{{url('/TemplateHome/dist/img/user.jpg')}}" class="img-circle mt-5"
                  style="width:15%;">
                <div class="media-body">
                  ...
                  <div class="row ml-3">
                    <a id="ulas_harga_perjam" class="col-md-4 text-left"><b class="bg-success">Rp. harga_perjam /
                        Jam</b></a>
                  </div><br>
                </div>
              </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6 mt-1 ml-2">
              <a id="bintang_1" type="button" onclick="cek_bintang(1)" style="color:grey;"><i
                  class="fas fa-star"></i></a>
              <a id="bintang_2" type="button" onclick="cek_bintang(2)" style="color:grey;"><i
                  class="fas fa-star"></i></a>
              <a id="bintang_3" type="button" onclick="cek_bintang(3)" style="color:grey;"><i
                  class="fas fa-star"></i></a>
              <a id="bintang_4" type="button" onclick="cek_bintang(4)" style="color:grey;"><i
                  class="fas fa-star"></i></a>
              <a id="bintang_5" type="button" onclick="cek_bintang(5)" style="color:grey;"><i
                  class="fas fa-star"></i></a>
            </div>
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-success"
            onclick="return confirm('Apakah Anda Yakin Dengan Data Anda?')"><i class="fas fa-pen"></i> Ulas</button>
          <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fa fa-times"></i>
            Cancel</button>
        </div>
      </form>
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        if (respon.response == 'success') {
          ...
          $('#ulas_tahun_ngajar').append('<a id="ulas_tahun_ngajar" class="col-md-6 text-left">' +
            pengalaman_ngajar + ' Tahun Mengajar</a>');
          $('#ulas_harga_perjam').empty();
          $('#ulas_harga_perjam').append(
            '<a id="ulas_harga_perjam" class="col-md-4 text-left"><b class="bg-success">' + harga_perjam +
            ' / Jam</b></a>');
        } else {
          console.log('Data Tidak Tersedia');
          alert('Data Tidak Tersedia');
