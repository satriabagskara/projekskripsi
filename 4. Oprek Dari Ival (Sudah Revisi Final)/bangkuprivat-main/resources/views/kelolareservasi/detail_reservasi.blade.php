...
<div class="content-header">
  <div class="container-fluid">
      <div class="row mb-2">
          <div class="col-sm-6">
              <h1 class="text-primary" style="font-size:30px;">Detail Reservasi, {{$detail_reservasi->user->nama}}</h1>
          </div>
          <div class="col-sm-6">
          ...
          @if($detail_reservasi->status_id == 10 || $detail_reservasi->status_id == 11 || $detail_reservasi->status_id == 12)
            <a href="{{url('/reservasi')}}" type="button" class="btn btn-warning"><i class="fa fa-reply"></i> Back</a>
          @else
            <a href="{{url('/request/reservasi')}}" type="button" class="btn btn-warning"><i class="fa fa-reply"></i> Back</a>
          @endif
      </div>
  </div>
</div>
          ...
          <div class="card" style="width:100%;">
            ...
            <div class="col-sm-12 mb-3">
              <div class="row ml-3">
                ...
                <a class="row col-md-10 ml-5" style="text-align:justify">{{$detail_reservasi->detail_kebutuhan}}</a>
              </div>
              <hr>
              <div class="row ml-3">
