                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="dataTable" class="table table-bordered table-hover text-center" width="100%"
                                    cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if (auth()->user()->level_id == 2 && $val->status_id == 10)
                                                        {{-- <a href="{{ url('/reservasi/selesai/' . $val->id) }}"
                                                            id="votebutton" type="button" class="btn btn-sm btn-success"><i
                                                                class="fas fa-check"></i>
                                                            Selesai</a> --}}

                                                        {{-- Coba --}}
                                                        <button onclick="submitPoll()"
                                                            href="{{ url('/reservasi/selesai/' . $val->id) }}"
                                                            id="votebutton" type="button" class="btn btn-sm btn-success"><i
                                                                class="fas fa-check">Selesai</i>
                                                        </button>

                                                    @endif
                                                    <a href="{{ url('/reservasi/detail/' . $val->id) }}" type="button"
                                                        class="btn btn-sm btn-info mt-1"><i class="fas fa-eye"></i>
                                                    </a>
                                                </td>
                                            </tr>
                                        @endforeach
