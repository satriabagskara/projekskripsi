...
@section('content')
                        ...
                        <div class="card-body mt-3">
                            <form class="form-horizontal" action="{{ url('/user/pengajuan/reservasi') }}" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6" style="margin-bottom:1%;">
                                        ...
                                        @foreach ($hari as $key => $val)
                                            <div class="row col-md-10">
                                                <div class="col-md-2">
                                                    <span><input type="checkbox" class="ml-3"
                                    ...
                                    <div class=" col-md-6" style="margin-bottom:1%;">
                                        <label for="" class="col-md-12">Tanggal Mulai dan Jam Mulai Belajar</label>

                                        <div class="col-md-6" style="margin-bottom:1%">
                                            <label for="">Tanggal Mulai :</label>
                                            <input type="datetime-local" id="tanggal_belajar">
                                        </div>
    ...
    <script>
        $(document).ready(function() {
            elem = document.getElementById("tanggal_belajar")
