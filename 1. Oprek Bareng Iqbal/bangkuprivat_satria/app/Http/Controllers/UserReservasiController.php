...
class UserReservasiController extends Controller
{
  ...
  public function pengajuan($id)
  {
    $detail_mentor = DB::connection()->table('master_user as a')
      ...
      ->select(
        ...
        'a.fhoto',
        'a.path_fhoto',
        'b.id as id_detail_mentor',
        'b.user_id as id_mentor',
        'b.detail_skill',
        'b.biodata',
        'b.detail_pengajaran',
        'b.pengalaman_ngajar',
    ...
    $ulasan_mentor = ulasan_mentor::join('tbl_reservasi', 'ulasan_mentor.reservasi_id', '=', 'tbl_reservasi.id')
      ...
      ->select(
        'master_user.nama',
        'master_user.path_fhoto',
        'master_user.fhoto',
        'ulasan_mentor.created_at',
        'ulasan_mentor.ulasan',
        'ulasan_mentor.bintang'
      )
      ->limit(5)
      ->get();
  ...
  public function get_data_pembayaran(Request $request)
  {
    ...
    $data_pembayaran = tbl_reservasi::join('pembayaran_reservasi', 'tbl_reservasi.pembayaran_id', '=', 'pembayaran_reservasi.id')
      ->select(
        'tbl_reservasi.id',
        'pembayaran_reservasi.bukti_transfer',
        'pembayaran_reservasi.path_bukti',
        'pembayaran_reservasi.atas_nama_pengirim',
        'pembayaran_reservasi.asal_bank'
      )
