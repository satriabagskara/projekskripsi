<aside class="main-sidebar sidebar-dark-primary elevation-4" >
  ...
  <div class="sidebar">
    <a class="brand-link">
      <img src="{{url('/TemplateHome/dist/img/logo_BP.png')}}" alt="Logo Bangku Privat" style="width:100%;">
    </a>
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="row ml-2">
        @if(auth()->user()->fhoto != null)
        <img src="{{url('/Foto_Profile/'.auth()->user()->path_fhoto,auth()->user()->fhoto)}}" class="elevation-2" alt="User Image" style="width:40%;">
        <a href="#" class="d-block mt-2 ml-2" style="font-size:22px;">{{auth()->user()->nama}}</a>
        @else
        <img src="{{url('/TemplateHome/dist/img/user.jpg')}}" class="img-circle elevation-2" alt="User Image" style="width:20%;">
        <a href="#" class="d-block mt-2 ml-2" style="font-size:22px;">{{auth()->user()->nama}}</a>
        @endif
      </div>
    </div>
    ...
    @if(auth()->user()->level_id == 3)
        ...
        <li class="nav-item">
          <a href="{{url('/pengajuan_mentor')}}" class="nav-link">
            ...
            <i id="icon_bell" class="nav-icon fas fa-bell text-danger" style="display:none;"></i>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item has-treeview">
          <a href="#" class="nav-link">
            ...
            <p>
              Reservasi
              <i id="div_icon_reservasi" class="nav-icon fas fa-bell text-warning" style="display:none;"></i>
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{url('/request/reservasi')}}" class="nav-link">
                ...
                <i id="icon_reservasi" class="nav-icon fas fa-bell text-warning" style="display:none;"></i>
              </a>
            </li>
          </ul>
          <ul class="nav nav-treeview">
    ...
    @if(auth()->user()->level_id == 2)
        <li class="nav-item has-treeview">
          <a href="#" class="nav-link">
            ...
            <p>Menu Mentor
              <i id="div_icon_reservasi_mentor" class="nav-icon fas fa-bell text-warning" style="display:none;"></i>
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{url('/request/reservasi')}}" class="nav-link">
                ...
                <i id="icon_reservasi_mentor" class="nav-icon fas fa-bell text-warning" style="display:none;"></i>
              </a>
            </li>
          </ul>
          <ul class="nav nav-treeview">
