              ...
              @foreach($history_reservasi as $key => $value)
                <div class="row" style="margin-bottom:auto;">
                  ...
                  <div class="card col-sm-2 text-center"><br><br>
                    <a href="{{url('/detail_reservasi/user/'.$value->id)}}" type="button" class="btn btn-sm btn-info"><i class="fas fa-eye"></i> Cek Detail</a></br>
                    @if($value->status_id == 10)
                      <a href="{{url('/reservasi/selesai/'.$value->id)}}" type="button" class="btn btn-sm btn-success"><i class="fas fa-check"></i> Selesai</a>
                    @endif
