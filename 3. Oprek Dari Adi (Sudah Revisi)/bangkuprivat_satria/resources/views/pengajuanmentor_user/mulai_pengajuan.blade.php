      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body mt-3">
            <form class="form-horizontal" action="{{url('/user/pengajuan_mentor')}}" method="post" enctype="multipart/form-data">
              @csrf
              <label style="font-size:12px;" class="text-danger"><i>*Note: Jangan Masukkan Kontak Pribadi (No. HP, Email, dan Sejenisnya).</i></label><br>
              ...
              <div id="tambah_skill" class="form-group row">
                  ...
                  <div id="div_keahlian0" class="form-group row col-md-12">
                    ...
                    <div class="col-md-3">
                      ...
                      <select id="keahlian0" onfocus="this.size=5;" onblur="this.size=5;" onchange="this.size=5; this.blur();"
                      onfocusout="this.size=null;" class="col-md-12 form-control" name="keahlian[]" onclick="pilih_skill(0);" required>
                    ...
                    <div class="col-md-3">
                      ...
                      <input id="pengalaman_bidang0" class="col-md-12 form-control" type="number" name="pengalaman_bidang[]" placeholder="Lama Pengalaman Di Bidang" required>
                    </div>
                    <!-- <div class="col-md-12">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-12" style="margin-bottom:1%;">
                    ...
                    <div class="row col-md-12">
                      ...
                      <div class="col-md-10">
                          <input id="start_jam{{$val->id}}" name="start_jam[]" type="time">
                          <label>s/d</label>
                  ...
                  <div class="col-md-12">
                    ...
                    <input id="harga_jam" class="col-md-12 form-control" type="text" name="harga_jam" placeholder="Harga Perjam" required>
                  </div>
                  <div class="col-md-12" style="margin-bottom:2%;">
                    <label for="pengalaman_ngajar">Pengalaman Mengajar (Dalam Tahun)</label>
                    <input id="pengalaman_ngajar" class="col-md-12 form-control" type="number" name="pengalaman_ngajar" placeholder="Pengalaman Mengajar (dalam tahun)." required>
                  </div>
              </div>
              <div class="form-group row">
                  ...
                  <div class="col-md-12">
                    ...
                    <input id="medsos_linkedin" class="col-md-6 form-control" type="text" name="medsos_linkedin" placeholder="Https://www.linkedin.com/in" required>
                  </div>
                  <div class="col-md-12">
                    <label for="medsos_github" class="col-md-12">Github</label>
                    <input id="medsos_github" class="col-md-6 form-control" type="text" name="medsos_github" placeholder="@Github" required>
                  </div>
                  <div class="col-md-12" style="margin-bottom:2%;">
                    <label for="medsos_instagram" class="col-md-12">Instagram</label>
                    <input id="medsos_instagram" class="col-md-6 form-control" type="text" name="medsos_instagram" placeholder="@Instagram" required>
                  </div>
              </div>
              <div class="form-group row">
                  ...
                  <div class="col-md-12" style="margin-bottom:1%;">
                    ...
                    <input id="file_resume" class="col-md-6 form-control" type="file" name="file_resume" required>
                  </div>
              </div>
              <div class="form-row" style="margin-left:20%;">
                  <div class="form-group mt-4 mb-5 col-md-8">
                    ...
                    <button type="submit" class="btn btn-primary" onclick="return confirm('Apakah Anda Yakin Dengan Data Anda?')"><i class="fa fa-save"></i> Ajukan</button>
                  </div>
              </div>
            </form>
          </div>
